        ...
        >
            ...
            <input
                ...
                onClick={() => {
                    ...
                    /**
                     * https://github.com/keycloakify/keycloakify/issues/952
                     */
                    // @ts-expect-error: Trusted Keycloak's code
                    document.getElementById("executionValue").value = new URL(window.location.href).searchParams.get("execution"); //"${execution}";
                    // @ts-expect-error: Trusted Keycloak's code
