        ...
        >
            ...
            <div className={kcClsx("kcRecoveryCodesActions")}>
                ...
                <button 
                  ...
                  id="copyRecoveryCodes" className={clsx("pf-c-button", "pf-m-link")} type="button">
                    <i className="pficon-blueprint" aria-hidden="true" /> {msg("recovery-codes-copy")}
                </button>
                {copied &&
                  <div className="pf-c-alert pf-m-success pf-m-inline kcRecoveryCodesSuccess">
                    {msg("recovery-codes-copied-complete")}
                  </div>
                }
            </div>
